                            ...
                            <table class="table table-striped" id="table-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="<?php echo e(route('materi.edit', Crypt::encrypt($data->id))); ?>" class="btn btn-success btn-sm"><i class="nav-icon fas fa-edit"></i> &nbsp; Edit</a>
                                                <form method="POST" action="<?php echo e(route('materi.destroy', $data->id)); ?>">
                                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('Judul materi')); ?>">
                                        </div>
                                        <div class="form-group">
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(__('deskripsi')); ?>"></textarea>
                                        </div>
                                        <div class="form-group">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Sistem-Informasi-Sekolah-master\resources\views/pages/guru/materi/index.blade.php ENDPATH**/ ?>